...
class Predict:
    def __init__(self, model_dir, model_name):
        ...
        self.predict = graph.get_tensor_by_name('conv2d/output/predict:0')

    def __call__(self, X):
        input = self.graph.get_tensor_by_name('conv2d/input/X:0')
        predict = self.graph.get_tensor_by_name('conv2d/output/predict:0')
